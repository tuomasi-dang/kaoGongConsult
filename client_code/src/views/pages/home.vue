    ...
    <div class="home_box">
      ...
      <div class="recomList_view">
        ...
        <div class="categoryList">
          <div class="item" @click="kaoyanziliaoRecomCategoryChange(-1)" style="cursor: pointer"
               :class="{active:kaoyanziliaoRecom_index==-1}">全部
          </div>
          <div class="item" v-for="(item,index) in kaoyanziliaoRecomCategorys"
               @click="kaoyanziliaoRecomCategoryChange(index)" :class="{active:kaoyanziliaoRecom_index==index}"
               style="cursor: pointer">
            {{ item }}
          </div>
        </div>
        <div class="recommendList">
          <div class="item" v-for="(item,index) in kaoyanziliaoRecomList" :key="index"
               @click="detailClick('kaoyanziliao',item.id)">
            <div class="img-box">
            ...
            <template #default="scope">
              <div class="home_item card-hover" @click="detailClick('baokaozhinan',scope.row.id)">
                ...
                <div class="home_content">
                  ...
                  <h3 class="position-title">{{ truncateText(scope.row.zhiweimingcheng, 16) }}</h3>
...
.recomList_view .recommendList .item:hover .content-box {
  bottom: 0px;
