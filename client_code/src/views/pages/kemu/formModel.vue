	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('kemu','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('kemu','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
