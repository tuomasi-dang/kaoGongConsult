			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="详情简介" prop="xiangqingjianjie">
						<editor class="list_editor" :value="form.xiangqingjianjie" placeholder="请输入详情简介" :readonly="!isAdd||disabledForm.xiangqingjianjie?true:false"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.xiangqingjianjie = res.data.data.xiangqingjianjie.replace(reg,'../../../cl22771684/file');
