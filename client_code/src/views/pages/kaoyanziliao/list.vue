	...
	<div class="list-page" :style='{}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('kaoyanziliao','新增')" @click="addClick">新增</el-button>
			</div>
		</el-form>
					...
					<div class="data_item" v-for="(item,index) in list" :key="index" @click.stop="detailClick(item.id)" >
						...
						<div class="data_content">
							<div class="data_title1">
								<span>资料名称：{{item.ziliaomingcheng}}</span>
							</div>
							<div class="data_title2">
								<span>资料分类：{{item.ziliaofenlei}}</span>
							</div>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/kaoyanziliaoAdd')
	}
	//判断是否从个人中心跳转
	...
	const getList = () => {
		...
		if (categoryIndex.value != -1) {
			params.ziliaofenlei = categoryList.value[categoryIndex.value]
		}
