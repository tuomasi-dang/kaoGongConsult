	...
	<div>
		<div class="center_view">
			...
			<div class="list_search_view">
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('discusskaoyanziliao','新增')">
						新增
					</el-button>
			...
			<el-table
                ...
                <el-table-column v-if="btnAuth('discusskaoyanziliao','修改')" label="禁用账号" :resizable='true' :sortable='false' align="left" header-align="left">
                    <template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('discusskaoyanziliao','修改')">
							修改						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)" >
							删除						</el-button>
						<el-button class="operate_btn" v-if="btnAuth('discusskaoyanziliao','查看评论')" type="warning" @click="commentClick(scope.row.id)">
							查看评论
						</el-button>
...
<script setup>
	...
	const tableName = 'discusskaoyanziliao'
	const formName = '考公资料评论表'
	...
	const commentClick=(id)=>{
		context?.$router.push('/discussdiscusskaoyanziliao?refid=' + id)
	}
