		...
		<div class="center_view">
			...
			>
				<div class="item" v-for="(item,index) in list" :key="item.id">
					...
					<div class="title">院校：{{item.yuanxiao}}</div>
					<div class="title">科目：{{item.kemu}}</div>
					<div class="btns">
						<el-button class="view_btn" type="info" v-if=" btnAuth('baokaozhinan','查看')" @click="infoClick(item.id)">
							详情
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(item.id)" v-if=" btnAuth('baokaozhinan','修改')">
							修改
						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(item.id)"  v-if="btnAuth('baokaozhinan','删除')">
							删除
						</el-button>
						<el-button class="operate_btn" v-if="btnAuth('baokaozhinan','查看评论')" type="warning" @click="commentClick(item.id)">
							查看评论
						</el-button>
					</div>
				</div>
